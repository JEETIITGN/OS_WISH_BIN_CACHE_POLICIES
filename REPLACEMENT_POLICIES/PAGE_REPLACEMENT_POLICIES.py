...
def Main():
    ...
    totalAccesses=0
    while True:
        input=raw_input("LRU Enter the access | ");
        if input == 'q':
            break
    ...
    while True:
        input=raw_input("APPROX Enter the access | ");
        if input == 'q':
            break
        totalAccesses=totalAccesses+1
        # LRU(input)
        ...
        print "HIT RATE IS | ",hitRate, "%"
    while True:
        input=raw_input("FIFO Enter the access | ");
        if input == 'q':
            break
        totalAccesses=totalAccesses+1
        # LRU(input)
        ...
        print "HIT RATE IS | ",hitRate, "%"
    while True:
        input=raw_input("LFU Enter the access | ");
        if input == 'q':
            break
        totalAccesses=totalAccesses+1
        # LRU(input)
        ...
        print "HIT RATE IS | ",hitRate, "%"
    while True:
        input=raw_input("RANDOM Enter the access | ");
        if input == 'q':
            break
        totalAccesses=totalAccesses+1
        # LRU(input)
